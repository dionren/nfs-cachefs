...
[![Version](https://img.shields.io/badge/version-v0.5.2-blue)](https://github.com/yourusername/nfs-cachefs/releases/latest)
...
```bash
# 下载发布包
wget https://github.com/dionren/nfs-cachefs/releases/download/v0.5.2/nfs-cachefs-v0.5.2-linux-x86_64.tar.gz

# 解压并安装
tar -xzf nfs-cachefs-v0.5.2-linux-x86_64.tar.gz
cd nfs-cachefs-v0.5.2-linux-x86_64
sudo ./install.sh
```
